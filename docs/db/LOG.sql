...
CREATE TABLE `LOG` (
  ...
  `OPERATION__NAME` varchar(20) CHARACTER SET utf8 DEFAULT NULL COMMENT '操作者名称',
  `OPERATION__TYPE` varchar(20) DEFAULT NULL COMMENT '操作类别',
  `OPERATION__DATE` datetime(6) DEFAULT NULL COMMENT '操作时间',
