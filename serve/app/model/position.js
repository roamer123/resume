...
module.exports = app => {
  ...
  const Position = app.model.define('POSITION', {
    ...
    JOB_CATEGORY_NAME: STRING, // 工作性质name
    ...
    POSITION_PROCESS_CODE: STRING, // 招聘状态code:PRERECRUITING:待招聘，RECRUITING:招聘中，STOPRECRUIT:招聘结束
    CREATED_BY: STRING,
    UPDATED_BY: STRING,
  }, {
  ...
  Position.queryPosition = async function() {
    return await this.findAll(Object.assign({
      limit: 200,
      attributes: [ 'ID', 'TECHNOLOGY_DIRECTION_CODE', 'NEED_ORGANIZATION_CODE', 'JOB_CATEGORY_CODE', 'JOB_CATEGORY_NAME', 'JOB_EXPERIENCE_DEMAND_CODE',
